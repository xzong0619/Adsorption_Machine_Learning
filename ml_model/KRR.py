# -*- coding: utf-8 -*-
"""
Created on Wed Mar 23 15:24:44 2022
...
param_grid = {#'alpha': [1e-4, 0.001, 0.01, 0.1, 1, 10, 100, 1000],# opt = 0.001
              'gamma': [1e-4, 1e-3, 0.01, 0.1, 0.5, 0.9]  # opt = 0.1
              }

krr = GridSearchCV(estimator = model, 
...
perm_importance = permutation_importance(krr_opt, X_test, y_test)
...
plt.savefig("KRR Feature Importance.png", dpi=1200)
